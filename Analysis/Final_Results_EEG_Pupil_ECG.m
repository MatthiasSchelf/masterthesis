...
baseDir = 'D:\UGent_gerelateerd\Masterproef\Data\Output_PP_EEG_Pupil_ECG';
...
figure;
subplot(3, 1, 1);
plot_mean(time_points_5, combined_CMI_5.mean, 'g');
title('Condition _5');
xlabel('Time Points');
ylabel('Value');
grid on;
...
subplot(3, 1, 3);
plot_mean(time_points_13, combined_CMI_13.mean, 'g');
title('Condition _13');
xlabel('Time Points');
ylabel('Value');
grid on;
