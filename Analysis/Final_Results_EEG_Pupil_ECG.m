...
figure;
plot_mean(time_in_ms_5, combined_CMI_5.mean, 'b');
...
figure;
plot_mean(time_in_ms_9, combined_CMI_9.mean, 'g');
...
figure;
plot_mean(time_in_ms_13, combined_CMI_13.mean, 'r');
...
figure;
hold on;
plot_mean(time_in_ms_13, combined_CMI_13.mean, 'r'); % Plot 13 first
plot_mean(time_in_ms_9, combined_CMI_9.mean, 'g');  % Plot 9 second
plot_mean(time_in_ms_5, combined_CMI_5.mean, 'b');  % Plot 5 last
