...
figure;
plot_mean(time_points_5, combined_rho_5.mean, 'b');
...
figure;
plot_mean(time_points_9, combined_I_9.mean, 'g');
...
figure;
plot_mean(time_points_9, combined_rho_9.mean, 'g');
...
figure;
plot_mean(time_points_13, combined_I_13.mean, 'r');
...
time_points_9 = 1:length(combined_I_9.mean);
time_points_13 = 1:length(combined_I_13.mean);
plot_mean(time_points_13, combined_I_13.mean, 'r'); % Plot 13 first
plot_mean(time_points_9, combined_I_9.mean, 'g');   % Plot 9 second
plot_mean(time_points_5, combined_I_5.mean, 'b');   % Plot 5 last
title('MI Overlap');
xlabel('Time Points');
ylabel('MI');
...
figure;
hold on;
plot_mean(time_points_13, combined_rho_13.mean, 'r'); % Plot 13 first
plot_mean(time_points_9, combined_rho_9.mean, 'g');   % Plot 9 second
plot_mean(time_points_5, combined_rho_5.mean, 'b');   % Plot 5 last
