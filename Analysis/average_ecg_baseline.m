% Function for average baseline of ECG
function average_baseline_value_ecg = average_ecg_baseline(ecg_baseline_5, ecg_baseline_9, ecg_baseline_13)
    ...
    average_baseline_series_ecg = mean([average_baseline_5, average_baseline_9, average_baseline_13], 2);

    % Calculate the average singular value.
    average_baseline_value_ecg = mean(average_baseline_series_ecg);
end
