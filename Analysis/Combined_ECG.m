...
for i = 1:length(participants)
    ...
    % MI, JMI and II calculations for average
    MI_ecg_average = calculateMI_ecg(difference_time_series_ecg);
    JMI_ecg_average = calculateJMI_ecg(difference_time_series_ecg);
    II_ecg_average = calculateII(difference_time_series_ecg, difference_time_series_ecg);
    
    % MI, JMI and II calculations for multivariate
    ...
    II_ecg_multivariate = calculateII(multivariate_difference_ecg, multivariate_difference_ecg);
end
