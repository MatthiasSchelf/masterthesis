% Function that calculates the difference between baseline anperiod of
% interest for ECG
function multivariate_difference_ecg = multivariate_ecg_difference(multivariate_time_series_ecg, single_baseline_value_ecg)
    ...
    % Subtract the single baseline value from each time point
    ...
    % differences into a single column (easier for further calculations).
