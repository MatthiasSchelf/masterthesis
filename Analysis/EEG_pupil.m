...
for i = 1:length(participants)
    ...
    II_average_average = calculateII(difference_time_series_eeg, difference_time_series_pupil);
    ...
    II_multivariate = calculateII(multivariate_difference_pupil, multivariate_difference_eeg);
end
