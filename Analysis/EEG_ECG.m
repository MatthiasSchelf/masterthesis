...
for i = 1:length(participants)
    ...
    II_average = calculateII(difference_time_series_ecg, difference_time_series_eeg);
    ...
    II_multivariate = calculateII(multivariate_difference_ecg, multivariate_difference_eeg);
