...
for i = 1:length(participants)
    ...
    II_eeg_average = calculateII(difference_time_series_eeg, difference_time_series_eeg);
    ...
    II_eeg_multivariate = calculateII(multivariate_difference_eeg, multivariate_difference_eeg);
end
