% Function to caluclatute the multivariate probability distribution across
% trials  of the EEG Periods of Interest
function time_resolved_distributions = multivariate_eeg_interest(eeg_data_selected_5, eeg_data_selected_9, eeg_data_selected_13)
    ...
    % Concatenate all eeg time series data
    ...
    % Pad the data with NaN values to ensure equal length (no equal length
    % = error)
    ...
    for t = 1:num_time_points
        ...
        % Store the mean and covariance in previously made cell array
    ...
    % (normally this is automatically the case.
