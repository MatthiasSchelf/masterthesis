...
for i = 1:length(participants)
    ...
    II_pupil_average = calculateII(difference_pupil, difference_pupil);
    ...
    II_pupil_multivariate = calculateII(multivariate_difference_pupil, multivariate_difference_pupil);
end
